...
function Hero() {
  return (
    <main className="relative overflow-hidden">
        ...
        className='w-[900px] h-[900px] rounded-[80px]
        bg-lightYellow absolute top-[-15%] right-[-15%] 
        -z-10 transform-gpu'>
        </motion.div>
            ...
            justify-between">
                ...
                md:text-left md:mt-0'>
                    ...
                    text-transparent'>
                        ...
                        w-[50px] top-0 right-0 md:right-[100px]'/>
                    </motion.h1>
                    <motion.h1 
                    variants={SlideUp(1)} 
                    initial="hidden"
                ...
                <div className='relative'>
                    ...
                    whileInView={{ opacity: 1, rotate: 75, x: 0, 
                        y: 0}}
                    transition={{ duration: 0.8 }}
                    src={Spoon} alt="" className='w-[350px] absolute 
                    bottom-[-120px] -left-16 rotate-[75deg] img-shadow'/>
                    <motion.img 
                    initial={{opacity: 0, rotate: 20, x: 200, 
                        y:100}}
                    whileInView={{ opacity: 1, rotate: 0, x: 0, 
        ...
        bg-lightYellow absolute top-[-30%] left-[70%] 
        z-0'>
